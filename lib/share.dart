...
class _ShareState extends State<Share> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('スケジュールの共有')),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            FilledButton(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        ChangeNotifierProvider<ActivationModel>(
                          create: (context) => ActivationModel(
                            Provider.of<ShareServiceInterface>(
                              context,
                              listen: false,
                            ),
                          ),
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [Icon(Icons.share), Text("スケジュールを共有する")],
              ),
            ),
            ...
            OutlinedButton(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [Icon(Icons.input_sharp), Text("スケジュールを取り込む")],
              ),
            ),
          ],
        ),
