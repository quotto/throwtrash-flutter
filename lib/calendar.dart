...
class _CalendarWidgetState extends State<CalendarWidget> {
  ...
  final _rollbackSnackBar = SnackBar(
    ...
    content:
        Text('他の端末でスケジュールが更新されました。', style: TextStyle(color: Colors.white)),
            ...
            Container(
                decoration: BoxDecoration(
                    color: trashColor(
                        ...
                        Theme.of(context)
                            .brightness), //_trashColorMap[trashList[index][i].trashType],
  ...
  Column _calendarColumn(List<int> allDateList,
      List<List<DisplayTrashData>> allTrashList, int pageIndex) {
    ...
    return Column(key: Key('calendar_column_$pageIndex'), children: [
      Flexible(
          flex: 1,
          child: FractionallySizedBox(
            heightFactor: 1.0,
                ...
                child: ListView(
                    ...
                    children: <Widget>[
                            ...
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) => ChangeNotifierProvider<
                                            ListModel>(
                                        create: (context) => ListModel(Provider
                                            .of<TrashDataServiceInterface>(
                                                context,
                                                listen: false)),
                      ...
                      ListTile(
                          ...
                          onTap: () async {
                            AccountLinkModel accountLinkModel =
                                AccountLinkModel(
                            ...
                            accountLinkModel.addListener(() {
                              if (accountLinkModel.accountLinkType ==
                                  AccountLinkType.iOS) {
                                launchUrl(
                                        Uri.parse(accountLinkModel
                                            .accountLinkInfo.linkUrl),
                                        mode: LaunchMode
