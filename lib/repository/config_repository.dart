...
class ConfigRepository implements ConfigRepositoryInterface {
  ...
  Future<bool> saveDarkMode(bool darkMode) async {
    return _preferences.setBool(DARK_MODE_KEY, darkMode);
  }

  @override
  Future<bool?> readDarkMode() async {
    return Future.value(_preferences.getBool(DARK_MODE_KEY));
  }

  @override
  Future<String?> getDeviceToken() async {
    return Future.value(_preferences.getString(DEVICE_TOKEN_KEY));
  }

  @override
  Future<bool> saveDeviceToken(String deviceToken) async {
    return _preferences.setString(DEVICE_TOKEN_KEY, deviceToken);
  }
}
