...
class AlarmRepository implements AlarmRepositoryInterface {
  ...
  static const ALARM_NEXT_DAY_NOTIFICATION_ENABLED_KEY =
      'ALARM_NEXT_DAY_NOTIFICATION_ENABLED';
  ...
  Future<Alarm?> readAlarm() async {
    ...
    bool nextDayNotificationEnabled =
        _preferences.getBool(ALARM_NEXT_DAY_NOTIFICATION_ENABLED_KEY) ?? false;
    ...
    try {
      return await _preferences.setInt(ALARM_HOUR_KEY, alarm.hour) &&
          ...
          await _preferences.setBool(
            ALARM_NEXT_DAY_NOTIFICATION_ENABLED_KEY,
