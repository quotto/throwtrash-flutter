...
void main() {
  group("TrashScheduleからJsonに変換",(){
    test("trash_valあり/単一のスケジュール/単一の例外日",() {
      TrashData trashData = TrashData(id: "001", type: "burn", trashVal: "燃えるゴミ",
          schedules: [TrashSchedule("weekday",  "0")], excludes: [ExcludeDate(12,1)]);
    ...
    test("trash_valなし/単一のスケジュール/例外日なし",() {
      TrashData trashData = TrashData(id: "001", type: "burn", trashVal: "",
          schedules: [TrashSchedule("weekday", "0")], excludes: []);
      expect(trashData.toJson().toString(),
    ...
    test("trash_valなし/複数のスケジュール+隔週（Map型）スケジュール/複数の例外日",() {
      TrashData trashData = TrashData(id: "001", type: "burn", trashVal: "",
          ...
          ], excludes: [ExcludeDate(12,1),ExcludeDate(3, 3)]);
      expect(trashData.toJson().toString(),
