...
@GenerateNiceMocks([MockSpec<CrashReportInterface>(), MockSpec<TrashDataServiceInterface>()])
void main(){
  SharedPreferences.setMockInitialValues({});
  MockTrashDataServiceInterface _trashDataService = MockTrashDataServiceInterface();
